...
<!-- [PAGE - Contact (Submission Failure)]
================================================== -->
...
================================================== -->
	<div data-role="content" data-theme="a">
		...
		<div class="submission_results">
			<h4>I'm sorry, your email did not go through.  Please try again.</h4>
			<a href="<?php echo base_url(); ?>index.php/mobile/contact" data-role="button" data-transition="fade" data-icon="arrow-l">Home</a>
...
<!-- =================== [END PAGE - Contact (Submission Failure)] -->
