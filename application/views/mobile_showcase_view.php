...
<!-- [PAGE - Work Showcase]
================================================== -->
<div data-role="page" id="work_showcase">
	<div data-role="header" data-theme="a">
		<h1>Portfolio &#45; Franco Haley</h1>
	...
	<div data-role="content" data-theme="a">
		...
		<div id="work_details">
			<?php foreach($query as $row):; ?>
				<img src="<?php echo base_url(); ?><?php echo $row->mobileLargePath; ?>" alt="<?php echo $row->imageTitle; ?>" />
				<p><strong>Screenshot &#45; <?php echo $row->imageTitle; ?></strong></p>
				<br />							
				<?php if($row->mobileAltPath):; ?>
					<img src="<?php echo base_url(); ?><?php echo $row->mobileAltPath; ?>" alt="<?php echo $row->imageAltTitle; ?>" />
					<p><strong>Screenshot &#45; <?php echo $row->imageAltTitle; ?></strong></p>
					<br />
				<?php endif; ?>
				
				<?php if($row->imageThirdLargePath):; ?>
					<img src="<?php echo base_url(); ?><?php echo $row->mobileThirdPath; ?>" alt="<?php echo $row->imageThirdTitle; ?>" />
		...
		<a href="<?php echo base_url(); ?>index.php/mobile/portfolio" data-role="button" data-transition="fade" data-icon="arrow-l">Back</a>
	</div><!-- #content -->
