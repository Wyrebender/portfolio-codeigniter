		...
		<div id="spotlight_graphic" class="center_layout">
			<div id="container_main">
				<div id="column_main" class="align_left">
					...
					<div id="section_post">
						<div class="post_link">
							<p><a href="<?php echo base_url(); ?>index.php/blog/new_post">Create New Post</a></p>
							<br />
							<hr />
						</div><!-- end post_link -->
						...
						<?php if($query):foreach($query as $row): ?>
							<br />
							<h2>
								<a href="<?php echo base_url(); ?>index.php/blog/post/<?php echo $row->postID ?>">
						...
						<?php endforeach; else:?>
							<br />
							<p><strong>There are no blog post yet. Please create a new post.</strong></p>
						<?php endif;?>
