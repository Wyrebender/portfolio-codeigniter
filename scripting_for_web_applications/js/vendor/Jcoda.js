...
Jcoda.carousel = function(options){
	...
	options.nextbutton.onclick = function(e){
		next();
		e.preventDefault();
	};
	
	options.previousbutton.onclick = function(e){
		previous();
		e.preventDefault();
	};
